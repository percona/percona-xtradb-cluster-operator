...
func (r *ReconcilePerconaXtraDBCluster) reconcileUsersSecret(ctx context.Context, cr *api.PerconaXtraDBCluster) (*corev1.Secret, error) {
	...
	if err == nil {
		...
		isChanged, err := setUserSecretDefaults(secretObj, cr.Spec.GeneratedSecretsOptions)
		if err != nil {
	...
	if _, err = setUserSecretDefaults(secretObj, cr.Spec.GeneratedSecretsOptions); err != nil {
		return nil, errors.Wrap(err, "set user secret defaults")
	}
...
func setUserSecretDefaults(secret *corev1.Secret, secretsOptions *api.GeneratedSecretsOptions) (isChanged bool, err error) {
	if secret.Data == nil {
...
func generatePass(secretsOptions *api.GeneratedSecretsOptions) ([]byte, error) {
