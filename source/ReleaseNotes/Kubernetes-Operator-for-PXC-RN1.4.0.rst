...
* :jirabug:`K8SPXC-231`: A :ref:`graceful stop/start of the cluster<operator-pause>` is implemented for PXC 8.0. For situations when it was not done, :ref:`crash recovery methods<operator-recovery>` are supported as well.
