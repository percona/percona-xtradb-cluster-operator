...
.. list-table::
   ...
   * - allowUnsafeConfigurations
     - boolean
     - ``false``
     - Prevents users from configuring a cluster with unsafe parameters such as starting the cluster with less than 3 nodes, with even number of nodes, or without TLS/SSL certificates
